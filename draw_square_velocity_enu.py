    ...
    while(not rospy.is_shutdown()):
        ...
        if(current_state.mode != 'OFFBOARD' and (rospy.Time.now() - last_req) > rospy.Duration(5.0)):
            ...
            if mission_step == 0:
                ...
                rospy.logwarn_once("Mission Step 2. Drawing square.")
                target_position.x = home_position.x + 3.0
                target_position.y = home_position.y
                target_position.z = home_position.z + 3.0
                ...
                rospy.logwarn_once("Mission Step 3. Drawing square.")
                target_position.x = home_position.x + 3.0
                target_position.y = home_position.y + 3.0
                target_position.z = home_position.z + 3.0
                ...
                rospy.logwarn_once("Mission Step 4. Drawing square.")
                target_position.x = home_position.x
                target_position.y = home_position.y + 3.0
                target_position.z = home_position.z + 3.0
                ...
                rospy.logwarn_once("Mission Step 5. Drawing square.")
                target_position.x = home_position.x
                target_position.y = home_position.y
                target_position.z = home_position.z + 3.0
